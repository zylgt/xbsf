<template>
   <div class='achievement'>
        ...
        <div class="filter-container">
          ...
          <el-button :loading="downloadLoading" class="filter-item" type="primary" icon="el-icon-download" >导出</el-button>
        </div>
        <!-- 查询结果 -->
...
<style>
.achievement .filter-container{
  display: flex;
  justify-content: flex-start;
  align-items: center;
  margin-bottom:30px;
}
.achievement .el-input{
  margin-right:20px;
}
.achievement .el-select{
  margin-right:20px;
}
.achievement .el-table thead{
  background-color:#EBEEF5;
}
.achievement .el-table thead tr,.achievement .el-table thead th{
  background-color:#EBEEF5;
}
</style>
